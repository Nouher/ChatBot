...
export default function Home() {
  ...
  return (
    <div className='container px-40 py-20'>
      <h1 className='text-7xl font-bold text-gray-400 text-center absolute z-0 top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] z-1'>ChatBot</h1>
      {
        chatLog.map((message, index) => (

          <div key={index} className='relative z-10  bg-gray-50 shadow-xl rounded-xl p-6 pb-10 mb-10'>
            <div ref={messagesEndRef} />
            <h1 className='text-4xl font-bold py-3 mt-10'>{message.message}</h1>
      ...
      <form className='mt-6 fixed bottom-6 w-[80%] z-40' onSubmit={handleSubmit}>
